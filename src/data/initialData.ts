...
import { VERIFIED_REAL_ESTATE_PROPERTIES } from './eusebioRealEstateData';

export const INITIAL_EUSEBIO_PROPERTIES: EusebioProperty[] = VERIFIED_REAL_ESTATE_PROPERTIES;
