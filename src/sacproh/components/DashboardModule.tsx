...
import { SacProhTicket } from '../types';
import { BarChart3, Clock, AlertTriangle, CheckCircle2, Activity, Building2, ShieldCheck, TrendingUp, Layers } from 'lucide-react';
...
const CATEGORY_COLORS: Record<string, string> = {
  'Suporte Técnico Equipamentos': '#0284C7', // Sky Blue
  'Rastreio & Entrega Centro Cirúrgico': '#E11D48', // Crimson Rose
  'Troca, Devolução & SAC': '#F59E0B', // Amber
  'Faturamento, NFe & Financeiro': '#10B981', // Emerald
  'Documentação & Registro ANVISA': '#8B5CF6', // Purple
  'Cotação Especial OPME & Insumos': '#EC4899'  // Pink
};
...
// Helper function to convert estimated/actual resolution time strings to numeric hours
...
export const DashboardModule: React.FC<DashboardModuleProps> = ({
  ...
  // 1. Calculate Volume of Calls by Sector/Category
  ...
  // 2. Calculate Average Resolution Time (in hours) by Sector
  ...
  // 3. Tickets Distribution by Priority
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Chart 1: Volume de Chamados Por Setor */}
        ...
        {/* Chart 2: Tempo Médio de Resolução (SLA em horas) por Setor */}
        <div className="bg-slate-950 border border-slate-800 p-6 rounded-3xl shadow-xl space-y-4">
          <div className="flex items-center justify-between border-b border-slate-800/80 pb-3">
            <div className="space-y-0.5">
              <h3 className="font-extrabold text-white text-base flex items-center gap-2">
      ...
      {/* Second Row: Distribution by Priority & Status */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* Chart 3: Prioridades de Chamados (Donut/Pie Chart) */}
        <div className="bg-slate-950 border border-slate-800 p-6 rounded-3xl shadow-xl space-y-4">
        ...
        {/* Chart 4: Status Operacional dos Chamados */}
        <div className="bg-slate-950 border border-slate-800 p-6 rounded-3xl shadow-xl space-y-4">
          <div className="border-b border-slate-800/80 pb-3">
            <h3 className="font-extrabold text-white text-base flex items-center gap-2">
