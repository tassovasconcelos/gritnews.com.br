...
-- Segurança: somente admins ativos visualizam/manipulam automação comercial.
do $$ begin
...
-- Templates iniciais: linguagem curta, consultiva e com opt-out explícito.
...
-- Cadência padrão comercial (não dispara sozinha): D0 WhatsApp, D0 email, D2 WhatsApp, D5 tarefa, D10 reativação.
