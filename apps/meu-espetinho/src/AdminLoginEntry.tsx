...
export default function AdminLoginEntry(){
  ...
  if(isGritApps)return <div style={{position:'relative'}}><a href="/admin/apps/leads" style={{...quickStyle,position:'fixed',right:18,bottom:18,zIndex:9999,background:'#0f766e'}}>Leads & Oportunidades</a><GritAppsAdmin/></div>;
