import { SacProhProduct, SacProhTicket, SacProhFaq } from '../types';
...
export const INITIAL_SACPROH_FAQS: SacProhFaq[] = [
  ...
  },
  {
    ...
    answer: 'Os equipamentos ProCirúrgica contam com garantia oficial de 24 a 60 meses. O SLA de atendimento técnico é de até 4 horas para chamados de Emergência Cirúrgica e até 24 horas para manutenção preventiva.'
  },
  {
    id: 'faq-4',
