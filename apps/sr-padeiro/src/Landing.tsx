  ...
  return <div className="landing">
    ...
    <main>
      <section className="lp-hero">
        <div><span className="pill">Gestão simples para pequenos negócios</span><h1>Seu negócio na palma da mão.</h1><p>Venda, controle caixa, estoque, despesas, clientes e resultados direto pelo celular — simples para operar e completo para administrar.</p><div className="lp-actions"><a className="btn-orange" href="#lead">Começar teste grátis <ArrowRight size={18}/></a><a className="btn-outline" href={whatsappHref} onClick={whatsappClick}><MessageCircle size={18}/> Falar no WhatsApp</a></div><small>Teste inicial de 7 dias. Sem cartão de crédito.</small></div>
        <div className="phone-demo"><small>Exemplo visual do painel</small><div className="phone-top">Sr. Padeiro</div><div className="phone-card"><span>Vendas de hoje</span><strong>R$ 2.847,50</strong></div><div className="phone-grid"><div><WalletCards/><span>Caixa</span><b>R$ 642</b></div><div><Boxes/><span>Estoque</span><b>8 alertas</b></div></div><button>+ NOVA VENDA</button></div>
      </section>
